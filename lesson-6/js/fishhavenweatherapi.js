...
const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5585010&appid=8f5d9b1cbaed68f59cc467dd13ff7fb8&units=imperial";
fetch(apiURL)
...
const forcastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&appid=8f5d9b1cbaed68f59cc467dd13ff7fb8&units=imperial";
fetch(forcastURL)
  .then((response) => response.json())
  .then((jsObject) => {
